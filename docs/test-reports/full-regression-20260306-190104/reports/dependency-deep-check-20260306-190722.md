...
Generated: 2026-03-06T18:07:29.088Z

## Rollup

- Direct dependencies: **27**
- Vulnerabilities: critical **0**, high **7**, moderate **3**, low **2**, total **12**
- Outdated packages: total **33**, major **23**, minor/patch **10**

## backend

- Direct dependencies: **19**
- Vulnerabilities: critical **0**, high **6**, moderate **3**, low **2**, total **11**
- Outdated: total **16**, major **10**, minor/patch **6**

High/Critical chains:
- `@nestjs/core` (high) via @nestjs/platform-express | fixAvailable={"name":"@nestjs/core","version":"11.1.16","isSemVerMajor":true}
- `@nestjs/platform-express` (high) via @nestjs/core, multer | fixAvailable={"name":"@nestjs/platform-express","version":"11.1.16","isSemVerMajor":true}
...
- `multer` (high) via multer:high:#1113635, multer:high:#1113636, multer:high:#1113996 | fixAvailable={"name":"@nestjs/platform-express","version":"11.1.16","isSemVerMajor":true}
...
- Outdated: total **11**, major **7**, minor/patch **4**
